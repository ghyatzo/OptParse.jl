...
# Marker for struct types generated by the `@parser` macro. Types subtyping
# `AbstractLiftedParser` carry an associated parser accessible via `lift(T)`,
# and are accepted directly by the entrypoints (`optparse(T, args)`, etc.).
